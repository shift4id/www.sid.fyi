...
const socials = [
  { Icon: Mail, link: "mailto:hi@sid.fyi", color: "text-red-500" },
  { Icon: Facebook, link: "https://facebook.com/sid.adusumelli", color: "text-orange-500" },
  { Icon: GitHub, link: "https://github.com/shift4id", color: "text-yellow-500" },
  { Icon: Instagram, link: "https://instagram.com/shift4id", color: "text-green-500" },
  { Icon: Linkedin, link: "https://linkedin.com/in/sid-a", color: "text-blue-500" },
  { Icon: Twitter, link: "https://twitter.com/shift4id", color: "text-purple-500" },
];
